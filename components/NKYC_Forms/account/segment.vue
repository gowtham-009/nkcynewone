<template>
    ...
    <button
      ...
      :class="[
        'w-full text-left px-5 py-4 rounded-2xl border-2 transition-all shadow-sm relative',
    ...
    >
      ...
      <div class="flex justify-between items-center">
        ...
        <i
          ...
          class="pi pi-check text-green-500 text-xl rounded-full bg-green-100 p-2"
        ></i>
      </div>
