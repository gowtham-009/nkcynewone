      ...
      <div class="w-full mt-1 px-2 p-1">
        ...
        <div class="w-full mt-3">
          ...
          <div class="grid grid-cols-1 gap-3 dark:bg-gray-800">
            ...
            <div v-if="bankoverwite" class="w-full p-1 flex justify-center items-center flex-col border-2 border-dashed border-gray-300">
              ...
              <Button type="button" @click="viewbankoverwrite()"
...
const back = async (event) => {
  ...
  if (!navigator.onLine) {
   ...
   return
    ...
    const digistatus = mydata?.payload?.metaData?.digi_info?.status
    const digiaddpath = mydata?.payload?.metaData?.digi_info?.aadhaarPdfPath
