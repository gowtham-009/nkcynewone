        ...
        <div class="w-full flex flex-col justify-between p-2 bg-white rounded-t-3xl dark:bg-black"
            ...
            <div class="w-full p-2 mt-2">
                ...
                <div class="w-full mt-2">
                    <p class="text-blue-950 font-normal text-sm text-center dark:text-gray-400">Signature looking
                        different?</p>
                    <p @click="fileUpload()"
                        class="text-center font-medium text-blue-600 mt-3 text-lg py-2 border-2 rounded-lg">Upload Photo
                    </p>
                </div>
